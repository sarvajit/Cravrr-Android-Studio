...
public class CheckRequest {
	...
	/**
	 * @return Returns a {@link #} object with the results of the transaction.
	 * @throws Exception
	 */
	public Response submit() throws Exception {
		...
		Http http = new Http(e4.getUrl(), GlobalGatewayE4.Version, hmac);
	...
	/**
	 * @param transaction_type {@link #} to be used for the transaction.
	...
	/**
	 * @param check_number {@link #}[30] Check number being used for the payment.
	 * @return {@link #CheckRequest}
	 */
	...
	/**
	 * @param checkType {@link #} type of check to be used for the transaction.
	 * @return {@link #CheckRequest}
	 */
	@NotNull
	...
	/**
	 * @param micr {@link #}[30] MICR associated with the transaction.
	 * @return {@link #CheckRequest}
	 */
	...
	/**
	 * @param account_number {@link #}[30] The bank account number of the check being used to complete payment.
	 * @return {@link #CheckRequest}
	 */
	...
	/**
	 * @param bank_id {@link #}[30] The bank routing number of the check being used to complete payment.
	 * @return {@link #CheckRequest}
	 */
